...
{
    public class IncreaseBrigadeItemCommand : AbstrCommandWithDA<bool>
    {
        private readonly int brigadeItemId;
        private readonly int quantity;
        private readonly int actorId;

        public IncreaseBrigadeItemCommand(int brigadeItemId, int quantity, int actorId, IUnitOfWork operateUnitOfWork, IMapper mapper)
